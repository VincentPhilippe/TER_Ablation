...
main.o : main.cc read_data.h maillage.h diffusion.h plic.h recul.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/main.o main.cc

diffusion.o : diffusion.cpp diffusion.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/diffusion.o diffusion.cpp

maillage.o : maillage.cpp maillage.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/maillage.o maillage.cpp

plic.o : plic.cpp plic.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/plic.o plic.cpp

read_data.o : read_data.cpp read_data.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/read_data.o read_data.cpp

recul.o : recul.cpp recul.h
	g++ -std=c++11 -Wall -I EigenLibrary/Eigen -c -o build/recul.o recul.cpp
