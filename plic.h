...
class plic {
  ...
  const Eigen::Matrix<double, Eigen::Dynamic, 2> Get_interface() const {return _interface;};
  const Eigen::Matrix<double, Eigen::Dynamic, 2> Get_ninterf() const {return _ninterf;};
